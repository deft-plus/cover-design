# Contributing to Cover UI

When contributing to this repository, please first discuss the change you wish to make via issue,
email, or any other method with the owners of this repository before making a change. Please note we
have a code of conduct, please follow it in all your interactions with the project. We love your
input! We want to make contributing to this project as easy and transparent as possible, whether
it's:
...
Merge requests are the best way to propose changes to the codebase. We actively welcome your Merge
requests:

1. Fork the repo and create your branch from `master`.
2. Ensure the styles looks awesome!
